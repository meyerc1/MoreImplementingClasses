...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.h_rect = rg.Rectangle(rg.Point(self.intersection_center.x - (self.width / 2), self.intersection_center.y - (self.letter_thickness / 2)), rg.Point(self.intersection_center.x + (self.width / 2), self.intersection_center.y + (letter_thickness / 2)))

        self.v_rect = rg.Rectangle(rg.Point(self.intersection_center.x - (self.letter_thickness / 2), self.intersection_center.y - (letter_thickness / 2)), rg.Point(self.intersection_center.x + (self.letter_thickness / 2), self.intersection_center.y + (self.height - (self.letter_thickness / 2))))
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        return CapitalT(self.v_rect.get_center(), self.v_rect.get_width(), self.h_rect.get_height(), self.h_rect.get_width())
